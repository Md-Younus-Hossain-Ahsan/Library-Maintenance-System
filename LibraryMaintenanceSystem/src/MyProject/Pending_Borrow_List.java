...
public final class Pending_Borrow_List extends javax.swing.JFrame {
    ...
    public void All_View(){
        ...
        try {
            ...
            String sql = "SELECT * FROM Borrow where brw_type = 'Pending'";
            
            PreparedStatement pst = con.prepareStatement(sql); 
            ResultSet res = pst.executeQuery();
            Borrow_List.setModel(new DefaultTableModel(null, new String[] {"Borrow ID","Student ID","Book ID","Borrow Date"}));
            long daysDifference;
            while (res.next()) {
                
                daysDifference = Pending_check_within_deadline(res.getDate("borrow_date").toString());
    ...
    public void All_View_from_dates(){
        ...
        try {
            ...
            String sql = "SELECT * FROM Borrow where brw_type = 'Pending' and borrow_date >= '"+ sdf.format(date1.getDate()) +"' and borrow_date <= '"+ sdf.format(date2.getDate()) +"'";
    ...
    public void Borrow_list_View_from_student_id(int student_id){
        ...
        try {
            ...
            String sql = "SELECT * FROM Borrow where student_id = '"+ student_id +"' and brw_type = 'Pending'";
    ...
    public long Pending_check_within_deadline(String borrowDate)
    { 
        LocalDate currentDate = LocalDate.now();
        
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        
        LocalDate today = LocalDate.parse(currentDate.format(formatter), formatter);
        LocalDate returnDeadline = LocalDate.parse(borrowDate, formatter).plusDays(7);
        
        long daysDifference = ChronoUnit.DAYS.between(today, returnDeadline);
                
        return daysDifference;
    }
        
    
    public void Find_the_remaining_days(String borrowDate)
    { 
        LocalDate currentDate = LocalDate.now();
        ...
        LocalDate today = LocalDate.parse(currentDate.format(formatter), formatter);
        LocalDate returnDeadline = LocalDate.parse(borrowDate, formatter).plusDays(7);
        return_date.setText(returnDeadline.format(formatter));
        
        long daysDifference = ChronoUnit.DAYS.between(today, returnDeadline);
                
        remaining.setText(Long.toString(daysDifference));
        
        if(daysDifference > 1)
            days_text.setText("days");
        else
            days_text.setText("day");        
    }
    ...
    private void initComponents() {
        ...
        days_text = new javax.swing.JLabel();
        ...
        Full_List = new javax.swing.JButton();
        ...
        getContentPane().add(remaining, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 310, 110, 20));
        ...
        Borrow_List.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Borrow ID", "Student ID", "Book ID", "Borrow Date"
            }
        ));
        ...
        jLabel9.setText("Return (Deadline)");
        ...
        getContentPane().add(return_date, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 310, 170, 20));
        ...
        days_text.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        days_text.setText("day/s");
        getContentPane().add(days_text, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 310, 60, 20));
        ...
        getContentPane().add(Reset, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 600, 120, 35));

        Receive.setBackground(new java.awt.Color(253, 229, 210));
        Receive.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Receive.setText("Receive");
        Receive.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 0)));
        Receive.setContentAreaFilled(false);
        Receive.setOpaque(true);
        Receive.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                ReceiveMouseMoved(evt);
            }
        });
        Receive.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mousePressed(java.awt.event.MouseEvent evt) {
                ReceiveMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                ReceiveMouseReleased(evt);
            }
        });
        ...
        getContentPane().add(Receive, new org.netbeans.lib.awtextra.AbsoluteConstraints(1170, 600, 120, 35));
        ...
        jLabel2.setText(" Pending Borrow List ");
        ...
        Full_List.setBackground(new java.awt.Color(253, 229, 210));
        Full_List.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Full_List.setText("Received List");
        Full_List.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 0)));
        Full_List.setContentAreaFilled(false);
        Full_List.setOpaque(true);
        Full_List.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                Full_ListMouseMoved(evt);
            }
        });
        Full_List.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Full_ListMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                Full_ListMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                Full_ListMouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                Full_ListMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                Full_ListMouseReleased(evt);
            }
        });
        Full_List.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Full_ListActionPerformed(evt);
            }
        });
        getContentPane().add(Full_List, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 110, 120, 30));
        ...
        getContentPane().add(Back, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 600, 120, 35));
    ...
    private void Borrow_ListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Borrow_ListMouseClicked
        ...
        try {
            borrow.search_info_of_pending(Integer.parseInt((String) model.getValueAt(i, 0)));
            Search_Student_Info(Integer.parseInt((String) model.getValueAt(i, 1)));
            Search_Book_Info();
        } catch (ClassNotFoundException ex) {}
        
        Find_the_remaining_days(borrow.getBorrow_date());
    ...
    private void Borrow_ID_SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Borrow_ID_SearchActionPerformed
        ...
        if(brw_id.getText().trim().equals("")){  
            ...
            Borrow borrow = new Borrow();
            try {
                borrow.search_info_of_pending(Integer.parseInt(brw_id.getText()));
            } catch (ClassNotFoundException ex) {}
    ...
    private void ReceiveMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReceiveMouseMoved
        Receive.setCursor(SignIN.cursor);
    }//GEN-LAST:event_ReceiveMouseMoved

    private void ReceiveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReceiveMouseClicked
        Receive.setBackground(new Color(255,255,0).brighter());
    ...
    private void ReceiveMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReceiveMouseEntered
        Receive.setBackground(new Color(253,229,196).brighter());
    ...
    private void ReceiveMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReceiveMouseExited
        Receive.setBackground(new Color(253,229,210));
        Receive.setForeground(Color.BLACK);
    }//GEN-LAST:event_ReceiveMouseExited

    private void ReceiveMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReceiveMousePressed
        Receive.setBackground(new Color(255,255,100).brighter());
        Receive.setForeground(Color.BLACK);
    }//GEN-LAST:event_ReceiveMousePressed

    private void ReceiveMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReceiveMouseReleased
        Receive.setBackground(new Color(253,229,210));
        Receive.setForeground(Color.BLACK);
    }//GEN-LAST:event_ReceiveMouseReleased

    private void ReceiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReceiveActionPerformed
        
        if(student_id.getText().trim().equals("") || student_name.getText().trim().equals("") || brw_id.getText().trim().equals("") || bk_id.getText().trim().equals("") || book_name.getText().trim().equals(""))
        {
        ...
        else
        {
            ...
            LocalDate currentDate = LocalDate.now();        
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");            
            borrow.update_into_borrow(Integer.parseInt(brw_id.getText()), currentDate.format(formatter));
            bookStock.decrease_the_amount_of_borrowed_book(Integer.parseInt(bk_id.getText()));
    ...
    private void Full_ListMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Full_ListMouseMoved
        Full_List.setCursor(SignIN.cursor);
    }//GEN-LAST:event_Full_ListMouseMoved

    private void Full_ListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Full_ListMouseClicked
        Full_List.setBackground(new Color(255,255,0).brighter());
        Full_List.setForeground(Color.WHITE);
    }//GEN-LAST:event_Full_ListMouseClicked

    private void Full_ListMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Full_ListMouseEntered
        Full_List.setBackground(new Color(253,229,196).brighter());
        Full_List.setForeground(Color.BLACK);
    }//GEN-LAST:event_Full_ListMouseEntered

    private void Full_ListMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Full_ListMouseExited
        Full_List.setBackground(new Color(253,229,210));
        Full_List.setForeground(Color.BLACK);
    }//GEN-LAST:event_Full_ListMouseExited

    private void Full_ListMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Full_ListMousePressed
        Full_List.setBackground(new Color(255,255,100).brighter());
        Full_List.setForeground(Color.BLACK);
    }//GEN-LAST:event_Full_ListMousePressed

    private void Full_ListMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Full_ListMouseReleased
        Full_List.setBackground(new Color(253,229,210));
        Full_List.setForeground(Color.BLACK);
    }//GEN-LAST:event_Full_ListMouseReleased

    private void Full_ListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Full_ListActionPerformed
        new Received_Borrow_List().setVisible(true);
    }//GEN-LAST:event_Full_ListActionPerformed
    ...
    private javax.swing.JButton Full_List;
    ...
    private javax.swing.JLabel days_text;
