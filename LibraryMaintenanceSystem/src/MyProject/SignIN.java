...
public class SignIN extends javax.swing.JFrame {
    ...
    public static String url = "jdbc:mysql://localhost:3306/library_maintenance_system";
        
    
       
    public SignIN() throws ClassNotFoundException, UnsupportedEncodingException, MessagingException {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Date, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 310, 180, -1));
        ...
        jLabel2.setText(" Welcome to the Library Maintenance System ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 46, 800, 80));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background_images/logo.png"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 160, 190, 140));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background_images/user.png"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 160, -1, 40));

        User_Name.setBackground(new java.awt.Color(253, 229, 210));
        ...
        getContentPane().add(User_Name, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 170, 220, 20));

        jSeparator1.setBackground(new java.awt.Color(102, 102, 0));
        jSeparator1.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator1.setFocusable(true);
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 190, 220, 10));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background_images/password.png"))); // NOI18N
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 220, -1, 35));
        ...
        getContentPane().add(Password, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 230, 220, 20));

        jSeparator2.setBackground(new java.awt.Color(0, 255, 255));
        jSeparator2.setForeground(new java.awt.Color(0, 153, 255));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 250, 220, 10));

        ShowPassword.setBackground(new java.awt.Color(253, 229, 210));
        ...
        getContentPane().add(ShowPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 270, 141, -1));

        Sign_IN.setBackground(new java.awt.Color(253, 229, 210));
        Sign_IN.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Sign_IN.setText("Sign IN");
        Sign_IN.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 0)));
        ...
        getContentPane().add(Sign_IN, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 310, 90, 40));
        ...
        getContentPane().add(Forgot, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 370, 260, -1));

        background_icon.setBackground(new java.awt.Color(255, 255, 255));
        background_icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background_images/bg.png"))); // NOI18N
        getContentPane().add(background_icon, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 800, 460));
    ...
    private void Sign_INActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Sign_INActionPerformed
        ...
        else if(User_Name.getText().equals(user.getUsername()) && Password.getText().equals(user.getPassword()))
        {
    ...
    private void Sign_INMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Sign_INMouseClicked
        Sign_IN.setBackground(new Color(255,255,0).brighter());
    ...
    private void Sign_INMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Sign_INMouseEntered
        Sign_IN.setBackground(new Color(253,229,196).brighter());
    ...
    private void Sign_INMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Sign_INMouseExited
        Sign_IN.setBackground(new Color(253,229,210));
        Sign_IN.setForeground(Color.BLACK);
    ...
    private void Sign_INMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Sign_INMousePressed
        Sign_IN.setBackground(new Color(255,255,100).brighter());
        Sign_IN.setForeground(Color.BLACK);
    ...
    private void ForgotMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ForgotMouseEntered
        Forgot.setForeground(new Color(253, 229, 196).brighter());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                } catch (ClassNotFoundException | UnsupportedEncodingException | MessagingException ex) {
                    Logger.getLogger(SignIN.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
